...
class Number{
    ...
    //  .so avoid it default constructors are also written.Btw there was no need of creating default constructor
    //  if not any single constructor was present in the class
        Number(){
            a = 0;
        }
